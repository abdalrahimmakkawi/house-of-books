...
export const AMBIENT_SOUNDS: AmbientSound[] = [
  ...
  { id: 'forest', name: 'Nature Forest', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3', icon: 'Trees' },
  { id: 'beach', name: 'Ocean Beach', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3', icon: 'Waves' },
  { id: 'rain', name: 'Rainy Day', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3', icon: 'CloudRain' },
];
        ...
        if (audio.paused) {
          audio.play().catch(e => {
            if (e.name !== 'NotAllowedError') {
              console.error("Ambient resume failed:", e.message);
            }
          });
        }
        return;
