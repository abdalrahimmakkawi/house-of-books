...
Kahneman discusses the two selves: the experiencing self, which lives in the present and feels pleasure and pain; and the remembering self, which keeps score and makes decisions. The remembering self is a storyteller that creates narratives about our experiences. This explains why we sometimes make decisions that aren't in our best interest—we're optimizing for the remembering self rather than the experiencing self.
...
Deep Work provides a comprehensive framework for cultivating focus and concentration in an age of distraction. Newport combines research evidence with practical strategies to help readers develop the skill of deep work. The book is both a critique of our distracted culture and a practical guide to reclaiming our ability to focus on what truly matters.`
  },
  {
    ...
    detailed_summary: `Sapiens: A Brief History of Humankind by Yuval Noah Harari is a sweeping narrative that traces the evolution of Homo sapiens from insignificant animals to rulers of the world. The book explores how our species came to dominate the planet through unique cognitive abilities, collective myths, and major revolutions in human history. Harari's account combines anthropology, biology, history, and economics to create a comprehensive understanding of human development.
...
The unification of humankind is a major theme in the book. Harari identifies three great unifiers: money, empires, and religion. Money is the most successful story ever told—it's a system of mutual trust that allows complete strangers to cooperate. Emppires have been the most common form of political organization for most of human history, creating cultural and political unity across vast territories. Religions provided superhuman legitimacy to social norms and values.
...
Sapiens is both a comprehensive history of our species and a meditation on what it means to be human. Harari's account challenges readers to think critically about the past, present, and future of humanity. The book has become a global phenomenon, translated into dozens of languages and sparking widespread debate about human nature and the direction of human civilization.`
  },
  {
    title: "The Alchemist",
    author: "Paulo Coelho",
    detailed_summary: `The Alchemist by Paulo Coelho is a mystical and philosophical novel that has become one of the most beloved books in modern literature. The story follows Santiago, a young Andalusian shepherd boy, on his journey to find treasure near the Egyptian pyramids. What begins as a literal quest for material wealth becomes a profound spiritual journey of self-discovery and personal transformation.
...
Mindset has had a profound impact on education, business, and personal development. The book provides a roadmap for anyone looking to achieve greater success and fulfillment by developing a growth mindset. Dweck's research shows that our beliefs about our abilities are not just minor personality traits—they're fundamental determinants of how we live our lives.`
  },
  {
    title: "Essentialism",
    author: "Greg McKeown",
    detailed_summary: `Essentialism: The Disciplined Pursuit of Less by Greg McKeown presents a systematic approach to determining what is absolutely essential and then eliminating everything that is not. The book argues that in a world where everything is urgent and important, the only way to regain control of our choices is to determine what is truly essential and eliminate everything else. Essentialism is not about how to get more things done; it's about how to get the right things done.
...
Essentialism has resonated with millions of readers because it speaks to the universal experience of feeling overwhelmed and overcommitted. The book provides a roadmap for anyone looking to reclaim their time, energy, and focus for what truly matters. McKeown's approach is both counter-cultural and deeply practical, challenging the assumption that more is always better.`
  },
  {
    title: "Zero to One",
    author: "Peter Thiel",
    detailed_summary: `Zero to One: Notes on Startups, or How to Build the Future by Peter Thiel presents a contrarian vision of innovation and entrepreneurship. Thiel, a co-founder of PayPal and early investor in Facebook, argues that the most valuable companies create something entirely new rather than competing in existing markets. The title refers to the act of creating new things—going from zero to one—versus copying things that already exist—going from one to n.
...
The Lean Startup has become essential reading for entrepreneurs, innovators, and business leaders. The book provides a systematic approach to innovation that reduces risk and increases the chances of success. Ries's methodology has been adopted by startups and large corporations around the world, transforming how new products and services are developed and launched.`
  ...
  // ... (continuing with the remaining 105 books)
];
...
async function updateAllSummaries() {
  try {
    ...
    for (let i = 0; i < books.length; i++) {
      const book = books[i];
      console.log(`Updating book ${i + 1}/${books.length}: ${book.title}`);
      
      // Find matching detailed summary
      const detailedSummary = detailedSummaries.find(
      ...
      if (detailedSummary) {
        ...
        const { error: updateError } = await supabase
          .from('summaries')
          .update({
            long_summary: detailedSummary.detailed_summary
          })
          .eq('book_id', book.id);
        ...
        console.log(`❌ No detailed summary found for: ${book.title} by ${book.author}`);
      }
    }
